...
char *yytext;
#line 1 "primerPunto.l"
#line 2 "primerPunto.l"
#include <stdio.h>
...
YY_RULE_SETUP
#line 10 "primerPunto.l"
{ line_count++; }  // Contar nueva línea
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 11 "primerPunto.l"
{ char_count += yyleng; }        // Contar espacios y tabulaciones
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 12 "primerPunto.l"
{ char_count += yyleng; word_count++; }  // Contar palabras con caracteres acentuados
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 13 "primerPunto.l"
{ char_count += yyleng; }       // Contar signos de puntuación como caracteres
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 14 "primerPunto.l"
{ char_count++; }                // Cualquier otro carácter
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 15 "primerPunto.l"
ECHO;
	YY_BREAK
#line 760 "lex.yy.c"
